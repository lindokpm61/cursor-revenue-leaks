-- Phase 1: Critical Security Fixes and Database Optimization (Final)

-- Fix 1: Drop views before altering columns they depend on
DROP VIEW IF EXISTS abandonment_analytics CASCADE;
DROP VIEW IF EXISTS email_sequence_analytics CASCADE;

-- Fix 2: Update all critical functions to have proper search_path for security
...
-- Fix 5: Recreate views without SECURITY DEFINER after column changes
