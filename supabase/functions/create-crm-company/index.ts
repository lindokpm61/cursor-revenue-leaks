      ...
      if (existingResult.data?.companies && existingResult.data.companies.length > 0) {
        ...
        const variables = {
          data: {
            ...
            averageDealValue: submissionData.average_deal_value || null,
            leadResponseTimeHours: submissionData.lead_response_time || null,
            monthlyFreeSignups: submissionData.monthly_free_signups || null,
            freeToPaidConversion: submissionData.free_to_paid_conversion || null,
            failedPaymentRate: submissionData.failed_payment_rate || null,
            manualHoursPerWeek: submissionData.manual_hours || null,
            hourlyRate: submissionData.hourly_rate || null,
